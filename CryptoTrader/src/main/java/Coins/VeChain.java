...
public class VeChain {
    ...
    private final Currency curr = Currency.VEN;

    private String API_KEY;
    private String API_SECRET;
    Trading trader;

    public VeChain(String username){
        stratedgy = null;
        amount = 0;
    ...
    public VeChain(String username, String stratedgy){
    ...
    public void checkTrade(){
        ...
        try {
            ...
            String wat = DataChecker.checkCoin(potentialBuy, prevWorth, currWorth, buyPrice, curr, BinancePriceDataAccessor.getDailyDelta().get("VEN"));

            if (wat.equals("buy")){
                double buy = (GUITest.amountBTC*.25)/(value);
                trader.buy("ven", buy, value);
                amount += buy;
                buyPrice = value;
