...
public class Ethereum {
    ...
    private final Currency curr = Currency.ETH;

    private String API_KEY;
    private String API_SECRET;
    Trading trader;

    public Ethereum(String username){
        stratedgy = null;
        amount = 0;
    ...
    public Ethereum(String username, String stratedgy){
    ...
    public void checkTrade(){
        ...
        try {
            ...
            String wat = DataChecker.checkCoin(potentialBuy, prevWorth, currWorth, buyPrice, curr, BinancePriceDataAccessor.getDailyDelta().get("ETH"));

            if (wat.equals("buy")){
                double buy = (GUITest.amountBTC*.25)/(value);
                trader.buy("eth", buy, value);
                amount += buy;
                buyPrice = value;
