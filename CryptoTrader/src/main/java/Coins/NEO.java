...
public class NEO {
    ...
    private final Currency curr = Currency.NEO;

    private String API_KEY;
    private String API_SECRET;
    Trading trader;

    public NEO(String username){
        stratedgy = null;
        amount = 0;
    ...
    public NEO(String username, String stratedgy){
    ...
    public void checkTrade(){
        ...
        try {
            ...
            String wat = DataChecker.checkCoin(potentialBuy, prevWorth, currWorth, buyPrice, curr, BinancePriceDataAccessor.getDailyDelta().get("NEO"));

            if (wat.equals("buy")){
                double buy = (GUITest.amountBTC*.25)/(value);
                trader.buy("neo", buy, value);
                amount += buy;
                buyPrice = value;
