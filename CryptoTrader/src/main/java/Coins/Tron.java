...
public class Tron {
    ...
    private final Currency curr = Currency.TRX;
    ...
    public Tron(String username, String stratedgy){
    ...
    public void checkTrade(){
        ...
        try {
            ...
            String wat = DataChecker.checkCoin(potentialBuy, prevWorth, currWorth, buyPrice, curr, BinancePriceDataAccessor.getDailyDelta().get("TRX"));

            if (wat.equals("buy")){
                double buy = (GUITest.amountBTC*.25)/(value);
                trader.buy("trx", buy, value);
                amount += buy;
                buyPrice = value;
