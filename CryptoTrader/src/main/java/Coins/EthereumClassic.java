...
public class EthereumClassic {
    ...
    private final Currency curr = Currency.ETC;

    private String API_KEY;
    private String API_SECRET;
    Trading trader;

    public EthereumClassic(String username){
        stratedgy = null;
        amount = 0;
    ...
    public EthereumClassic(String username, String stratedgy){
    ...
    public void checkTrade(){
        ...
        try {
            ...
            String wat = DataChecker.checkCoin(potentialBuy, prevWorth, currWorth, buyPrice, curr, BinancePriceDataAccessor.getDailyDelta().get("ETC"));

            if (wat.equals("buy")){
                double buy = (GUITest.amountBTC*.25)/(value);
                trader.buy("etc", buy, value);
                amount += buy;
                buyPrice = value;
